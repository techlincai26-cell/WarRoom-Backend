...
type Assessment struct {
	...
	// New flow fields
	Capital           float64         `gorm:"column:capital;not null;default:0" json:"capital"`
	CapitalSource     string          `gorm:"column:capital_source;not null;default:''" json:"capitalSource"`
	BudgetAllocations json.RawMessage `gorm:"column:budget_allocations;type:json" json:"budgetAllocations"`
	BuyoutChosen      bool            `gorm:"column:buyout_chosen;not null;default:false" json:"buyoutChosen"`
...
type Stage struct {
	ID            string          `gorm:"primaryKey;type:varchar(191)" json:"id"`
	AssessmentID  string          `gorm:"column:assessmentId;index;uniqueIndex:uq_assessment_stage,priority:1;not null;type:varchar(191)" json:"assessmentId"`
	StageName     string          `gorm:"column:stageName;index;uniqueIndex:uq_assessment_stage,priority:2;not null" json:"stageName"`
...
type Response struct {
	ID                   string          `gorm:"primaryKey;type:varchar(191)" json:"id"`
	AssessmentID         string          `gorm:"column:assessmentId;index;index:idx_response_assessment_stage_question,priority:1;not null;type:varchar(191)" json:"assessmentId"`
	StageID              string          `gorm:"column:stageId;index;index:idx_response_assessment_stage_question,priority:2;not null;type:varchar(191)" json:"stageId"`
	QuestionID           string          `gorm:"column:questionId;index;index:idx_response_assessment_stage_question,priority:3;not null;type:varchar(191)" json:"questionId"`
	...
	CompetenciesAssessed json.RawMessage `gorm:"column:competencies_assessed;type:json;not null" json:"competenciesAssessed"`
...
type CompetencyScore struct {
	ID              string          `gorm:"primaryKey;type:varchar(191)" json:"id"`
	AssessmentID    string          `gorm:"column:assessmentId;index;uniqueIndex:uq_assessment_competency,priority:1;not null;type:varchar(191)" json:"assessmentId"`
	CompetencyCode  string          `gorm:"column:competencyCode;index;uniqueIndex:uq_assessment_competency,priority:2;not null" json:"competencyCode"`
